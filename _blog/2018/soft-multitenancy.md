...
within Kubernetes. However, from their work so far it is clear that only "soft multitenancy"
...
limited multitenancy support. When official multitenancy support is provided, the
[docs]({{home}}/docs/) section will be updated with details.
...
## Challenges with other multitenancy models
Other multitenancy deployment models were considered:
